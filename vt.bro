...
export {
    redef Notice::mail_dest = "cyberwoman99@gmail.com";
	...
	if ( n$note == MalwareHashCheck::VTMalicious )
		...
		n$email_body_sections[|n$email_body_sections|] = fmt("Name: Doreen Joseph; NetID: djoseph4");
	}
    ...
    const vt_apikey = "224bbf7dd3e0926fa0f44a60b9dce003087dc355197c764663db27e3ec288bee" &redef;
